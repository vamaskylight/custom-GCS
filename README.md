...
| **Current milestone** | **M0** — project setup, minimal UI, first MAVLink link |
...
At **M0**, the app is intentionally small: prove a **reproducible dev environment** and a **working MAVLink link**.

| Capability | Description |
|------------|-------------|
| **Connection string** | Edit the pymavlink-style string (default `udp:127.0.0.1:14550` for typical SITL). |
| **Connect / Disconnect** | Start and stop the link without freezing the UI. |
| **Status** | Shows disconnected / connected state and last **HEARTBEAT** information (system id, component id). |
| **Log** | Append-only log of connection events and HEARTBEAT lines. |

Later milestones add telemetry, maps, video, and more.
...
You should see the **“VGCS — link test”** window: connection string field, **Connect** / **Disconnect**, status line, and log.
